...
class fwd_gnn_resid(nn.Module):
    ...
    def apply_func(self, nodes):                              
        ...
        if ('fwd_msgs_redux' in nodes.data.keys()):             
            ...
            concat_feats = th.cat((embeds0, nodes.data['fwd_msgs_redux'].reshape((node_count, self.hidden_dim))), -1)
            embeds       = self.act(self.node_embeds(concat_feats))
            embeds       = self.act(self.node_embeds1(th.add(embeds, embeds0)))  
            embeds       = self.act(self.node_embeds2(th.add(embeds, embeds0)))                        
            embeds       = self.act(self.node_embeds3(th.add(embeds, embeds0)))  
            embeds       = self.act(self.node_embeds4(th.add(embeds, embeds0)))                        
    ...
    def redux_func(self, nodes):       
        ...
        if (is_unary==True):
            msgs_redux0 = self.act(self.mp_unary(nodes.mailbox['fwd_msgs']))
            msgs_redux  = self.act(self.mp_unary1(msgs_redux0))
            msgs_redux  = self.act(self.mp_unary2(th.add(msgs_redux, msgs_redux0)))
            msgs_redux  = self.act(self.mp_unary3(th.add(msgs_redux, msgs_redux0)))
            msgs_redux  = self.act(self.mp_unary4(th.add(msgs_redux, msgs_redux0)))
            msgs_redux  = self.act(self.mp_unary5(th.add(msgs_redux, msgs_redux0)))

        else:
            msgs_concat = nodes.mailbox['fwd_msgs'].reshape((node_count, 1, 2*self.hidden_dim))
            msgs_redux0 = self.act(self.mp_binary(msgs_concat)) 
            msgs_redux  = self.act(self.mp_binary1(msgs_redux0))
            msgs_redux  = self.act(self.mp_binary2(th.add(msgs_redux, msgs_redux0)))
            msgs_redux  = self.act(self.mp_binary3(th.add(msgs_redux, msgs_redux0)))
            msgs_redux  = self.act(self.mp_binary4(th.add(msgs_redux, msgs_redux0)))
            msgs_redux  = self.act(self.mp_binary5(th.add(msgs_redux, msgs_redux0)))
...
class bwd_gnn_resid(nn.Module):
    ...
    def apply_func(self, nodes):                              
        ...
        if ('bwd_msgs_redux' in nodes.data.keys()):             
            ...
            embeds       = self.act(self.node_embeds3(th.add(embeds, embeds0)))
            embeds       = self.act(self.node_embeds4(th.add(embeds, embeds0)))
            embeds       = self.act(self.node_embeds5(th.add(embeds, embeds0)))
    ...
    def redux_func(self, nodes):       
        ...
        msgs_redux0  = self.act(self.mp_bwd(msgs_sum))
        msgs_redux   = self.act(self.mp_bwd1(msgs_redux0))
        msgs_redux   = self.act(self.mp_bwd2(th.add(msgs_redux, msgs_redux0)))
        msgs_redux   = self.act(self.mp_bwd3(th.add(msgs_redux, msgs_redux0)))
        msgs_redux   = self.act(self.mp_bwd4(th.add(msgs_redux, msgs_redux0)))
        msgs_redux   = self.act(self.mp_bwd5(th.add(msgs_redux, msgs_redux0)))
...
class comb_state_resid(nn.Module):
    def __init__(self, feat_dim, hidden_dim):
        ...
        self.predict4 = nn.Linear(hidden_dim, CLASSES)
    ...
    def forward(self, fwd_states, bwd_states):
        ...
        pred = self.act(self.predict(comb_embed))
        pred = self.act(self.predict1(th.add(pred, comb_embed)))
        pred = self.act(self.predict2(th.add(pred, comb_embed)))
        pred = self.act(self.predict3(th.add(pred, comb_embed)))

        pred = th.sigmoid(self.predict4(th.add(pred, comb_embed))) 
